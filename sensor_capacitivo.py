...
def leer_sensores():
   try:
       ...
       valor_crudo = soil_sensor.read()
       print("Valor crudo capacitivo:", valor_crudo)
       
       # Para capacitivo (menor valor = más húmedo)
       soil_percent = ((4095 - valor_crudo) * 100) / 4095
